...
public class ConstantManager {
    ...
    public static final String MODE_EDIT_KEY = "MODE_EDIT_KEY";

    public static final String USER_EMAIL_KEY = "USER_EMAIL_KEY";
    public static final String USER_PHONE_KEY = "USER_PHONE_KEY";
    public static final String USER_GIT_1_KEY = "USER_GIT_1_KEY";
    public static final String USER_GIT_2_KEY = "USER_GIT_2_KEY";
